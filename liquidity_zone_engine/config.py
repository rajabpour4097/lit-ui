...
class EngineConfig:
    ...
    sweep_reclaim_min_bars: int = 1
    sweep_min_displacement_atr: float = 0.5
    smc_max_swings: int = 20
    smc_swing_min_pct: float = 0.0015
    smc_swing_min_atr: float = 0.3
    smc_zone_cluster_atr: float = 0.15
    smc_max_zones_total: int = 12
    smc_bos_window: int = 5
    smc_max_sweeps_output: int = 10
    smc_sweep_rejection_atr: float = 0.5
    smc_sl_atr_buffer: float = 0.2
    smc_liquidity_proximity_pct: float = 0.002
    swing_dedupe_pct: float = 0.0005
    smc_sweep_base_score: int = 60
    smc_sweep_reversal_score: int = 20
    smc_sweep_zone_score: int = 20
    lit_swing_post_displacement_atr: float = 0.8
    macro_max_zones: int = 4
    macro_min_zones: int = 0
    macro_merge_overlap: float = 0.6
    mid_max_zones: int = 5
    mid_min_zones: int = 0
    micro_max_zones: int = 3
    micro_min_zones: int = 0
    min_total_zones: int = 0

    min_sweep_score: int = 60
